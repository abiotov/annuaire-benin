...
- [x] **Étape 4 : atlas économique.** [Page interactive publiée](https://abiotov.github.io/annuaire-benin/atlas/) : choroplèthe des 77 communes **directement sur fond [OpenStreetMap](https://www.openstreetmap.org/)** (Leaflet vendorisé, pan/zoom libre jusqu'à la rue, vol animé vers la commune cliquée, masque qui fait ressortir le pays de ses voisins), **[vue 3D](https://abiotov.github.io/annuaire-benin/atlas/#m=3d)** où chaque commune s'extrude en prisme selon son nombre d'entreprises (MapLibre GL vendorisé, rotation et inclinaison libres, échelle racine documentée), recherche de commune, filtre par secteur, légende interactive, panneau de détail avec classement, vue tableau triable, liens partageables (état dans l'URL), icônes SVG, thèmes clair et sombre, animations respectant `prefers-reduced-motion`. Zéro donnée individuelle : agrégats commune × secteur uniquement.
